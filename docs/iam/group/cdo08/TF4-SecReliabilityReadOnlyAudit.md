...
Cho phép người dùng thiết lập kết nối an toàn và chuyển tiếp cổng (Port Forwarding Session) từ máy cá nhân thông qua Session Manager tới Bastion host được chỉ định (`i-072084d1cf0b2f1c9`), cũng như tự quản lý phiên kết nối SSM của mình.
